...
__decorate([
    (0, swagger_1.ApiOperation)({ description: '', summary: '创建用户' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ description: '', summary: '登录用户' }),
    (0, skip_jwt_passport_decorator_1.SkipJwtPassport)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ description: '', summary: '用户列表查询' }),
    (0, skip_jwt_passport_decorator_1.SkipJwtPassport)(),
    (0, common_1.Get)('/list'),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [query_user_dto_1.PageQueryDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, swagger_1.ApiOperation)({ description: '', summary: '更新用户' }),
    (0, common_1.Patch)(':id'),
...
__decorate([
    (0, swagger_1.ApiOperation)({ description: '', summary: '删除用户' }),
